...
Vue.component("purple_background_cta_component_1721929617", {
    template: `
        ...
        <div id="section-container" class="max-w-6xl mx-auto px-4 sm:px-6 bg-white">
            <div id="content-container" class="relative px-8 py-12 md:py-20 rounded-[3rem] overflow-hidden">
                ...
                <div id="content" class="max-w-3xl mx-auto text-center">
                    <div id="content-subtitle" class="flex"><div id="content-subtitle-text" class="flex-1 font-medium bg-clip-text pb-3 text-transparent bg-gradient-to-r from-purple-500 to-purple-200">Unravel the Complexities of Blockchain</div></div>
...
<div class="flex-1">
    <button class="btn bg-purple-600 text-white hover:bg-purple-700 transition duration-150 ease-in-out mt-4 px-6 py-2 rounded-full shadow-lg hover:shadow-xl">Hello World</button>
</div>
                </div>
            </div>
        </div>
